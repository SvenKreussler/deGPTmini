...
If you peek inside it, you'll see that we're training a GPT with a context size of up to 256
...
It is a good idea to benchmark your interconnect (e.g. iperf3). In particular, if you don't have
